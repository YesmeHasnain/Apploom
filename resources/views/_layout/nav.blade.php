@php
    ...
    // Default placeholder
    $avatarUrl = '/img/profile/profile-9.webp';

    if ($user && $user->avatar) {
        $raw = $user->avatar;

        // If it's a full URL (social login etc.)
        if (Str::startsWith($raw, ['http://', 'https://', 'data:'])) {
            $avatarUrl = $raw;
        }
        // If it's a storage path like "avatars/xxx.jpg"
        elseif (Storage::disk('public')->exists($raw)) {
            $avatarUrl = asset('storage/'.$raw);
        }
        // If someone stored a public-path like "images/..." inside /public
...
<div class="nav-content d-flex">
    ...
    <div class="user-container d-flex">
        ...
        <a href="#" class="d-flex user position-relative" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
            <img class="profile" alt="profile" src="{{ $avatarUrl }}" />
        ...
        @guest
        <a href="{{ route('login') }}" class="d-flex user position-relative">
                ...
                <div class="scroll">
                    <ul class="list-unstyled border-last-none">
                        <li class="mb-3 pb-3 border-bottom border-separator-light d-flex">
                            ...
                            <div class="align-self-center"><a href="#">Joisse Kaycee just sent a new comment!</a></div>
                        </li>
                        <li class="mb-3 pb-3 border-bottom border-separator-light d-flex">
                            <img src="/img/profile/profile-2.webp" class="me-3 sw-4 sh-4 rounded-xl align-self-center" alt="..." />
                            <div class="align-self-center"><a href="#">New order received! It is total $147,20.</a></div>
                        </li>
                        <li class="mb-3 pb-3 border-bottom border-separator-light d-flex">
                            <img src="/img/profile/profile-3.webp" class="me-3 sw-4 sh-4 rounded-xl align-self-center" alt="..." />
                            <div class="align-self-center"><a href="#">3 items just added to wish list by a user!</a></div>
                        </li>
                        <li class="pb-3 pb-3 border-bottom border-separator-light d-flex">
                            <img src="/img/profile/profile-6.webp" class="me-3 sw-4 sh-4 rounded-xl align-self-center" alt="..." />
                            <div class="align-self-center"><a href="#">Kirby Peters just sent a new message!</a></div>
                        </li>
                    </ul>
                </div>
            </div>
